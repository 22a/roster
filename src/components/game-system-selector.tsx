    ...
    const fetchRepositoryData = async () => {
      ...
      if (shouldCache) {
        ...
        if (localStorageCache) {
          ...
          console.log(
            'loading bsDataRepositoryIndex from localStorage cache',
            bsDataRepositoryIndex,
          );
        }
      }
      if (!bsDataRepositoryIndex) {
        ...
        if (shouldCache) {
          window.localStorage.setItem(
            ...
            JSON.stringify(bsDataRepositoryIndex),
          );
          console.log(
            'caching bsDataRepositoryIndex from network in localStorage',
            bsDataRepositoryIndex,
          );
        } else {
          console.log(
            'shouldCache disabled, fetched bsDataRepositoryIndex from network',
            bsDataRepositoryIndex,
          );
        }
      }
      ...
      if (autoSelectDefault) {
        const defaultSelection = bsDataRepositoryIndex.repositories.find(
